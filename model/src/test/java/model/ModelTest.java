...
public class ModelTest {
    ...
    public void testContentOfMap() {
      Assert.assertEquals("", this.model.getGame().getContentOfMap());
    }
    ...
    public void testGetNumberOfDiamondsNeeded() {
        ...
        Assert.assertEquals(3, this.model.getGame().getNumberOfDiamondsNeeded());
        this.model.loadMap(2);
        Assert.assertEquals(5, this.model.getGame().getNumberOfDiamondsNeeded());
        this.model.loadMap(3);
        Assert.assertEquals(7, this.model.getGame().getNumberOfDiamondsNeeded());
        this.model.loadMap(4);
        Assert.assertEquals(9, this.model.getGame().getNumberOfDiamondsNeeded());
        this.model.loadMap(5);
        Assert.assertEquals(10, this.model.getGame().getNumberOfDiamondsNeeded());
    }
    ...
    public void testGetContentOfMap() {
        ...
        assertEquals("qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq\r\n" + 
        		...
        		"qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq", this.model.getGame().getContentOfMap());
        this.model.loadMap(2);
        assertEquals("qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq\r\n" + 
